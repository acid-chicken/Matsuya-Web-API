...
// RandomV2InternalServerError runs the method Random of the given controller with the given parameters.
// It returns the response writer so it's possible to inspect the response headers.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func RandomV2InternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.V2Controller) http.ResponseWriter {
	// Setup service
	var (
		logBuf bytes.Buffer
