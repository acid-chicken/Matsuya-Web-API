...
import (
	...
	"github.com/makotia/Matsuya-Web-API/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "Matsuya-Web-API-cli",
		Short: `CLI client for the Matsuya-Web-API service`,
	}
	...
	app.PersistentFlags().StringVarP(&c.Host, "host", "H", "matsuya.makotia.me", "API hostname")
	...
	c.UserAgent = "Matsuya-Web-API-cli/0"
